                ...
                <div class='row'>
                    <div class='col-12'>
                        <p class='font-weight-bold w-100 h3 ranking-name'>
                            <a href='<?php echo $user->screenName ?>' style='word-break: break-all;' class='link text-dark'><?php echo $user->screenName ?></a>
                        </p>
                    </div>
        ...
        <div class="p-3 row col-md-8 offset-md-2 mt-3 border-bottom border-secondary">
            ...
            <div class="col-8">
                <div class="row">
                    <div class="col-12">
                        <p class='font-weight-bold w-100 h3 ranking-name'>
                            <a href="<?php echo $rankingUserData->screenName; ?>" style='word-break: break-all;' class='link text-dark'><?php echo $rankingUserData->screenName; ?></a>
                        </p>
                    </div>
                    <div class="col-12 mb-2 mt-1">
                        <p class='ranking-bio'>
